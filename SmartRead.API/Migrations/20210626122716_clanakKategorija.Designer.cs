...
namespace SmartRead.API.Migrations
{
    ...
    [Migration("20210626122716_clanakKategorija")]
    partial class clanakKategorija
    {
            ...
            modelBuilder.Entity("SmartRead.API.Database.Korisnik", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DatumRegistracije = new DateTime(2021, 6, 26, 14, 27, 15, 712, DateTimeKind.Local).AddTicks(5901),
                            ...
                            Obrisan = false,
                            PasswordHash = "RPCcKAO7qBhn8dk0vTMLj5bxZaVQ7EL3pk1YtaU5ugMniRt8Yp+b8JueIMVIFS6WWZ/7htU50k67wb9sbFcHiA==",
                            PasswordSalt = "/4TRrALZzz6gi0epmQEpXw==",
                            Prezime = "Bešlagić",
                            Username = "maid"
                        });
                });
